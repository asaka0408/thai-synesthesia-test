class ColorSpaceViewer {
    ...
    init() {
        ...
        // Mousedown listener for wheel click (button 1)
        ...
        // Block automatic scrolling behaviour triggered by wheel clicks completely
        ...
        // Mousemove updates position unconditionally (no click required) + processes middle-drag rotation
        this.renderer.domElement.addEventListener('mousemove', (e) => {
            ...
            // Always update current targeted color and append trajectory sample
            this.checkIntersectionAndSelect(e.clientX, e.clientY);
        });

        // Wheel Scroll Zooming: Automatically triggers re-selection under static cursor position
