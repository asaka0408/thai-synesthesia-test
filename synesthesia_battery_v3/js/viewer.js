class ColorSpaceViewer {
    ...
    init() {
        ...
        // Fixed perspective view angles to see the color cloud clearly
        ...
        // White ring marker for the current color selection
        ...
        // Interaction bindings: Drag to select color, Scroll to zoom
        ...
        // Wheel Scroll implementation for Zooming in/out
    ...
    buildAxesLines() {
        const matWhite = new THREE.LineBasicMaterial({ color: 0xffffff, transparent: true, opacity: 0.25 });
    ...
    buildColorSphereCloud() {
        ...
        const material = new THREE.PointsMaterial({ size: 1.8, vertexColors: true, transparent: true, opacity: 0.8 });
